...
const ROUTE_API = {
  ...
  notificationRead: (id: number) => `/api/v1/notifications/${id}/read`,
  notificationReadAll: '/api/v1/notifications/read-all',
  notificationStreamTicket: '/api/v1/notifications/stream-ticket',
  notificationStream: '/api/v1/notifications/stream',
  loginRefreshToken: '/api/v1/auth/refresh',
  loginChangePassword: '/api/v1/auth/change-password',
  loginForgotPassword: '/api/v1/auth/forgot-password',
  loginConfirmCode: '/api/v1/auth/confirm-code',
  loginConfirmChangePassword: '/api/v1/auth/confirm-change-password',
  loginViaSms: '/api/v1/auth/forgot-password-via-sms',
